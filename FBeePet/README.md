<div align="center">
 <h1>FBeePet</h1>
  ...
  <p>
    <a href="https://github.com/FBeePet-ai/FBeePet/stargazers"><img src="https://img.shields.io/github/stars/FBeePet-ai/FBeePet?style=social" alt="GitHub stars"></a>
    <a href="https://github.com/FBeePet-ai/FBeePet"><img src="https://img.shields.io/badge/Python-3.8+-blue.svg" alt="Python"></a>
    <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-yellow.svg" alt="License"></a>
  </p>
  <img src="https://github.com/user-attachments/assets/5a848b1f-04bf-40ff-8249-8a453294f444" alt="FBeePet Logo" width="680">
</div>
...
FBeePet 是一个更加符合中文用户习惯的轻量级 AI Agent 框架，也是一个面向本地部署与长期运行的 AI Agent 中枢。

它把角色、团队、工作流、工具调用、记忆、大模型、IM 渠道和本地工作空间连接起来，让 AI 具备长期运行、跨入口协作与任务执行能力。

你可以把 FBeePet 理解为一个框架和中枢：
...
一句话概括：**FBeePet 是连接模型、渠道、团队和工具的 AI Agent 框架与运行中枢。**

FBeePet 由自然语言而生。FBeePet 的愿景，不是让更多人先学会复杂配置和编程再去使用 AI，而是让普通用户也能直接通过自然语言与 AI 交互，完成信息获取、内容生成、任务拆解、工具调用、流程编排，乃至搭建属于自己的个人助手、团队协作流与自动化系统。
...
- **v0.9.0**
  ...
  - 优化模型预设界面并更新构建产物
  - 发布说明：[https://FBeePet.cn/docs/releases/v0.9.0](https://FBeePet.cn/docs/releases/v0.9.0)
...
- **v0.7.0**
  ...
  - 发布说明：[https://FBeePet.cn/docs/releases/v0.7.0](https://FBeePet.cn/docs/releases/v0.7.0)
...
- **v0.6.0**
  ...
  - 发布说明：[https://FBeePet.cn/docs/releases/v0.6.0](https://FBeePet.cn/docs/releases/v0.6.0)
...
- **v0.5.0**
  ...
  - 发布说明：[https://FBeePet.cn/docs/releases/v0.5.0](https://FBeePet.cn/docs/releases/v0.5.0)

- **v0.4.0**
  - 引入会话级配置，支持不同会话使用不同模型与提示词
  - 扩展飞书、企业微信、微博、小智 AI 等渠道能力
  - 优化多智能体协作，新增 `/help` 等使用入口
  - 发布说明：[https://FBeePet.cn/docs/releases/v0.4.0](https://FBeePet.cn/docs/releases/v0.4.0)

- **v0.3.0**
  - 多智能体协作（`pipeline` / `graph` / `council`）首次体系化落地
  - 定时任务、技能配置、工作空间管理能力显著增强
  - 发布说明：[https://FBeePet.cn/docs/releases/v0.3.0](https://FBeePet.cn/docs/releases/v0.3.0)

- **v0.2.0 · 2026-02-26**
  - 聚焦 Bug 修复、交互体验优化与构建流程整理
  - 让 FBeePet 从“基础可运行”进一步走向“稳定可迭代”

- **正式开源 · 2026-02-21**
  - FBeePet 首次开源，开放基础框架、启动脚本、Agent 核心、渠道系统、工具系统、技能系统与前端基础能力
  - 项目从这一天开始持续公开迭代
...
FBeePet 从自然语言驱动软件的趋势出发，致力于让 AI 真正落地到真实任务与日常工作中。
...
OpenClaw 已经在本地执行、自主 Agent 方向上验证了可行路径。在此基础上，FBeePet 聚焦补齐**中文场景适配、轻量化部署、易用性扩展、安全管控与治理能力**等关键缺口。

FBeePet 不只是对话式 AI 应用，而是一套面向真实任务、可部署、可扩展、可治理的开源基础设施，让普通用户也能通过自然语言驱动 AI、组织工具、连接渠道，真正落地业务与日常流程。
...
```bash
git clone https://github.com/FBeePet-ai/FBeePet.git
cd FBeePet
...
```bash
git clone https://gitee.com/FBeePet-ai/FBeePet.git
```

### 方式二：桌面版体验

- Gitee Releases: https://gitee.com/FBeePet-ai/FBeePet/releases
- GitHub Releases: https://github.com/FBeePet-ai/FBeePet/releases
...
| 文档 | 说明 | 链接 |
|------|------|------|
| 快速开始 | 安装、配置、启动 | [https://FBeePet.cn/docs/getting-started/quick-start-guide](https://FBeePet.cn/docs/getting-started/quick-start-guide) |
| 配置手册 | 完整配置说明 | [https://FBeePet.cn/docs/getting-started/configuration-manual](https://FBeePet.cn/docs/getting-started/configuration-manual) |
| 部署与运维 | 启动、部署、排障 | [https://FBeePet.cn/docs/advanced/deployment](https://FBeePet.cn/docs/advanced/deployment) |
| 远程访问指南 | 远程初始化、认证、排障 | [https://FBeePet.cn/docs/advanced/remote-access](https://FBeePet.cn/docs/advanced/remote-access) |
| 认证说明 | 密码初始化与访问边界 | [https://FBeePet.cn/docs/advanced/auth](https://FBeePet.cn/docs/advanced/auth) |
| API 参考 | REST API 与 WebSocket | [https://FBeePet.cn/docs/api-reference](https://FBeePet.cn/docs/api-reference) |
| 发布说明 | 版本演进记录 | [https://FBeePet.cn/docs/releases/v0.8.0](https://FBeePet.cn/docs/releases/v0.8.0) |

完整站点文档请查看：[https://FBeePet.cn/docs](https://FBeePet.cn/docs)
...
- QQ 交流群：`1028356423`
- 讨论方向：FBeePet 使用、问题反馈、二次开发、场景共创

### 问题反馈

- GitHub Issues: https://github.com/FBeePet-ai/FBeePet/issues
...
<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/FBeePet-ai/FBeePet">GitHub</a> ·
    <a href="https://gitee.com/FBeePet-ai/FBeePet">Gitee</a> ·
    <a href="https://FBeePet.cn/docs">完整文档</a>
  </p>
</div>
