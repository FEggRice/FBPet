<div align="center">
  <img src="https://github.com/user-attachments/assets/d42ee929-a9a9-4017-a07b-9eb66670bcc3" alt="FBeePet Logo" width="180">
  <h1>FBeePet</h1>
  ...
  <p>
    ...
    <a href="https://github.com/FBeePet-ai/FBeePet"><img src="https://img.shields.io/badge/Python-3.11+-blue.svg" alt="Python"></a>
...
FBeePet is a lightweight AI agent framework that better fits Chinese users' habits, and also a runtime hub built for local deployment and long-running operation.
...
You can think of FBeePet as both a framework and a hub:
...
- **v0.2.0 · 2026-02-26**
  ...
  - Pushed FBeePet from "basically runnable" toward "stable and ready to iterate"

- **Official Open Source Release · 2026-02-21**
  - FBeePet was open-sourced for the first time, including the base framework, startup scripts, agent core, channel system, tool system, skill system, and foundational frontend capabilities
...
FBeePet starts from the broader trend of software being driven by natural language, and aims to let AI truly land in real tasks and everyday work.
...
OpenClaw has already validated a viable path for local execution and autonomous agents. On top of that, FBeePet focuses on filling key gaps in **Chinese scenario adaptation, lightweight deployment, usability expansion, security control, and governance**.

FBeePet is not merely a conversational AI application. It is open infrastructure for real tasks: deployable, extensible, and governable, so ordinary users can use natural language to drive AI, organize tools, connect channels, and actually land business and daily workflows.
...
- QQ group: `1028356423`
- Discussion topics: FBeePet usage, issue feedback, secondary development, and scenario co-creation
