  ...
  <div class="skills-library">
    <div class="skills-header">
      <div class="top-tabs">
        ...
        <button
          class="top-tab"
          :class="{ active: activeTopTab === 'FBeePetGuide' }"
          @click="activeTopTab = 'FBeePetGuide'"
        >
          <component
            :is="PlusIcon"
            :size="16"
          />
          {{ $t('skills.FBeePetGuideTab') }}
        </button>
        <button
          class="top-tab"
    ...
    <div
      v-else-if="activeTopTab === 'FBeePetGuide'"
      class="guide-view"
    >
      <div class="guide-hero">
        <h3>{{ $t('skills.FBeePetGuideTitle') }}</h3>
        <p>{{ $t('skills.FBeePetGuideDescription') }}</p>
        <div class="guide-badges guide-hero-badges">
          <span class="requirement-tag">{{ $t('skills.FBeePetHeroBadgeLocal') }}</span>
          <span class="requirement-tag">{{ $t('skills.FBeePetHeroBadgeSpec') }}</span>
          <span class="requirement-tag">{{ $t('skills.FBeePetHeroBadgeBoundary') }}</span>
        </div>
      </div>
      ...
      <div class="guide-grid">
        <section class="guide-card full-width guide-install-card">
          <div class="guide-section-head">
            <h4>{{ $t('skills.FBeePetInstallTitle') }}</h4>
            <p>{{ $t('skills.FBeePetInstallDesc') }}</p>
          </div>

          <div class="guide-methods-grid">
            <article class="guide-method preferred">
              <span class="guide-method-tag">{{ $t('skills.FBeePetMethod1Tag') }}</span>
              <h5>{{ $t('skills.FBeePetMethod1Title') }}</h5>
              <p>{{ $t('skills.FBeePetMethod1Desc') }}</p>
              <code class="path-block">Skills → {{ $t('skills.createSkill') }}</code>
            </article>

            <article class="guide-method">
              <span class="guide-method-tag">{{ $t('skills.FBeePetMethod2Tag') }}</span>
              <h5>{{ $t('skills.FBeePetMethod2Title') }}</h5>
              <p>{{ $t('skills.FBeePetMethod2Desc') }}</p>
              <code class="path-block">workspace/skills/&lt;skill-name&gt;/</code>
            </article>

            <article class="guide-method">
              <span class="guide-method-tag">{{ $t('skills.FBeePetMethod3Tag') }}</span>
              <h5>{{ $t('skills.FBeePetMethod3Title') }}</h5>
              <p>{{ $t('skills.FBeePetMethod3Desc') }}</p>
...
python3 skills/find-skills/scripts/skillhub_tool.py install &lt;slug&gt; --json</pre>
              ...
              <p class="guide-note inline-guide-note">{{ $t('skills.FBeePetMethod3Hint') }}</p>
            </article>
          </div>
        </section>

        <section class="guide-card">
          <h4>{{ $t('skills.FBeePetStructureTitle') }}</h4>
          <p>{{ $t('skills.FBeePetStructureDesc') }}</p>
          <div class="guide-structure">
            <code>skills/</code>
            <code>└── &lt;skill-name&gt;/</code>
            <code>&nbsp;&nbsp;&nbsp;&nbsp;└── SKILL.md</code>
          </div>
          <p class="guide-note">{{ $t('skills.FBeePetStructureHint') }}</p>
        </section>

        <section class="guide-card">
          <h4>{{ $t('skills.FBeePetBestPracticeTitle') }}</h4>
          <ul class="guide-list">
            <li>{{ $t('skills.FBeePetBestPracticePoint1') }}</li>
            <li>{{ $t('skills.FBeePetBestPracticePoint2') }}</li>
            <li>{{ $t('skills.FBeePetBestPracticePoint3') }}</li>
          </ul>
        </section>

        <section class="guide-card full-width">
          <h4>{{ $t('skills.FBeePetWorkflowTitle') }}</h4>
          <ol class="guide-steps">
            <li>{{ $t('skills.FBeePetWorkflowStep1') }}</li>
            <li>{{ $t('skills.FBeePetWorkflowStep2') }}</li>
            <li>{{ $t('skills.FBeePetWorkflowStep3') }}</li>
            <li>{{ $t('skills.FBeePetWorkflowStep4') }}</li>
          </ol>
        </section>

        <section class="guide-card full-width">
          <h4>{{ $t('skills.FBeePetTipsTitle') }}</h4>
          <ul class="guide-list">
            <li>{{ $t('skills.FBeePetTipsPoint1') }}</li>
            <li>{{ $t('skills.FBeePetTipsPoint2') }}</li>
            <li>{{ $t('skills.FBeePetTipsPoint3') }}</li>
          </ul>
        </section>
      </div>
    </div>
...
const activeTopTab = ref<'library' | 'FBeePetGuide' | 'openclawGuide'>('library')
