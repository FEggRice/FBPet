      ...
      <div class="sidebar-panel">
        <div class="sidebar-header">
          <div class="sidebar-brand">
            <img src="@/assets/fbepet-logo.svg" alt="FBeePet Logo" class="sidebar-logo" />
        ...
        <div class="sidebar-body">
          ...
          <div class="project-section">
            ...
            <div class="project-links">
              <a
                href="https://github.com/FBeePet-ai/FBeePet"
                target="_blank"
              ...
              >
                ...
                <div class="project-link-content">
                  ...
                  <span class="project-link-desc">FBeePet · 基于 FBeePet</span>
                </div>
...
async function handleLogout() {
  try {
    ...
    localStorage.removeItem('FBeePet_token')
